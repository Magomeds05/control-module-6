class Figure:
    ...
    def __is_valid_color(self, r, g, b): #служебный
    ...
    def __is_valid_sides(self, *sides): #служебный
...
class Triangle(Figure):
    ...
    def get_square(self):
        half_per = len(self) / 2
        return (half_per * (half_per - self.__side1) * (half_per - self.__side2) * (half_per - self.__side3))
